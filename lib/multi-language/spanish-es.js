...
smsAutodetec3: (usuario, m) => `*» ${usuario}*\n*𝙃𝘼 𝘾𝘼𝙈𝘽𝙄𝘼𝘿𝙊 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊, 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎:\n\n${m.messageStubParameters[0]}`, 
...
smsAutodetec5: (groupMetadata, usuario) => `*𝙀𝙇 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀 ${groupMetadata.subject} 𝙃𝘼 𝙎𝙄𝘿𝙊 𝙍𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝙋𝙊𝙍:*\n*» ${usuario}*`, 
   ...
   smsAutodetec6: (m, usuario, groupMetadata) => {
  // Si groupMetadata o su subject son undefined, se usa un valor por defecto.
  const subject = groupMetadata && groupMetadata.subject ? groupMetadata.subject : "Grupo sin nombre";

  return `${m.messageStubParameters[0] === 'on' ? '❱❱ 𝙂𝙍𝙐𝙋𝙊 𝘾𝙀𝙍𝙍𝘼𝘿𝙊 ❰❰' : '❱❱ 𝙂𝙍𝙐𝙋𝙊 𝘼𝘽𝙄𝙀𝙍𝙏𝙊 ❰❰'}
  ${subject}
...
${m.messageStubParameters[0] === 'on' ? '» 𝙉𝘼𝘿𝙄𝙀 𝙋𝙐𝙀𝘿𝙀 𝙀𝙎𝘾𝙍𝙄𝘽𝙄𝙍 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊.' : '» 𝙏𝙊𝘿𝙊𝙎 𝙋𝙐𝙀𝘿𝙀𝙉 𝙀𝙎𝘾𝙍𝙄𝘽𝙄𝙍 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊.'}`;
  ...
  smsAutodetec7: (m, usuario) =>  `❱❱ 𝙁𝙀𝙇𝙄𝘾𝙄𝘿𝘼𝘿𝙀𝙎 ❰❰

👤 *@${m.messageStubParameters[0].split`@`[0]}* 
» 𝘼𝙃𝙊𝙍𝘼 𝙀𝙎 𝘼𝘿𝙈𝙄𝙉.\n\n» 𝘼𝘾𝘾𝙄𝙊́𝙉 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝘿𝘼 𝙋𝙊𝙍: 
👤 *${usuario}*`, 
smsAutodetec8: (m,  usuario) => `❱❱ 𝙄𝙉𝙁𝙊𝙍𝙈𝘼𝘾𝙄𝙊́𝙉 ❰❰
