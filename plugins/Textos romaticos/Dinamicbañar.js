...
let handler = async (m, { conn, usedPrefix, command, text }) => {
  if (!text) throw `🛀🏻 *¡Oops! Olvidaste mencionar al usuario con el que quieres bañarte!* 🚿\n\n✨ *Ejemplo:*\n\n.bañar @kevin`
  ...
  try {
    ...
    let menu = `━━━━━━━━━━━━━━━━━━\n🛁 *@${m.sender.split("@")[0]} está bañándose con* *${text}* 🛀🏻🚿✨\n\n💖 *¡Relájate y disfruta del baño!*\n\n━━━━━━━━━━━━━━━━━━\n©𝘌𝘭𝘪𝘵𝘦𝘉𝘰𝘵𝘎𝘭𝘰𝘣𝘢𝘭 -`.trim()

    const img = './src/baño.jpg'  // Cambié el video por una imagen, usa la ruta de tu imagen
