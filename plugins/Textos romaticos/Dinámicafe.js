...
let handler = async (m, { conn, usedPrefix, command, text }) => {
  if (!text) throw `☕ *¿Con quién quieres compartir un café?*\n\n✨ *Ejemplo:*\n\n.tomarcafe @kevin`
  ...
  try {
    ...
    let menu = `━━━━━━━━━━━━━━━━━━\n☕ *@${m.sender.split("@")[0]}* 𝘴𝘦 𝘦𝘴𝘵𝘢́ 𝘵𝘰𝘮𝘢𝘯𝘥𝘰 𝘶𝘯 𝘤𝘢𝘧𝘦́ 𝘤𝘰𝘯 *${text}* 🤎\n\n💬 *Un cafecito y buena compañía lo arreglan todo.*\n━━━━━━━━━━━━━━━━━━\n©𝘌𝘭𝘪𝘵𝘦𝘉𝘰𝘵𝘎𝘭𝘰𝘣𝘢𝘭 -`.trim()

    const img = './src/cafe.jpg' // Imagen local para "tomar café"
    ...
    await m.reply(
      `${lenguajeGB['smsMalError3']()} ☕\n*Hubo un error inesperado.*\n\n📩 *Repórtalo con:* ${usedPrefix}${lenguajeGB.lenguaje() == 'es' ? 'reporte' : 'report'}`
    )
